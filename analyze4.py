    ...
    for weight_type in weight_types:
        ...
        for subject_id in subject_ids:
            ...
            for day in days:
                ...
                # '가격'이 0이 아닌 경우에만 합산
                cnt += len(subject_df[subject_df['식사유형'] == '간식'])
...
plt.title('체중 유형별 일 평균 간식 횟수', fontsize=16, fontweight='bold')
plt.xlabel('체중유형', fontsize=12, labelpad = 15)
plt.ylabel('일 평균 간식 횟수 (단위: 회)', fontsize=12)
# plt.show()
plt.savefig('일평균간식.png')
